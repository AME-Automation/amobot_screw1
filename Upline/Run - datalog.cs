...
public class RunState
{
	...
	*/
	...
	private string AllRunDataPath=@"\\172.25.1.10\shareDoc\TestLog\Galiote\MAPS\0521test\";
			...
			if (CheckAutoRun() && (CurStep == 100))
			{
				...
				*/
				...
				try
				{
					...
					csvData.Add(_trayInTime.ToString("yyyy-MM-dd HH:mm:ss"));
					csvData.Add(_trayDockTime.ToString("yyyy-MM-dd HH:mm:ss"));
					csvData.Add(_trayReleaseTime.ToString("yyyy-MM-dd HH:mm:ss"));
					csvData.Add(_trayOutTime.ToString("yyyy-MM-dd HH:mm:ss"));
